...
parser.add_argument("--dataset_dir", type=str, default='D:/create_sift/data/nerf_llff_data/trex', help="where the dataset is stored")
...
def cal_correspondences(src_kp_des, dst1_kp_des, dst2_kp_des, saved_file, img_shape):    
    ...
    if len(valid_matches1) < 100: # for speed up purpose
        with open(saved_file, 'w') as f:
            print("not enough matched sift")
            return
